...
### /api/v1/supervisor/conf?id=976e43e1-3e5d-422e-968c-994217801d9d (GET)
returns  supervisor conf

### /api/v1/supervisor/workers?host=localhost (GET)
...
### /api/v1/topology?id=WordCount3-1-1402960825&window=600&sys=false (GET)
...
### /api/v1/topology/component/id=WordCount3-1-1402960825&component=spout&window=0&sys=false(GET)
