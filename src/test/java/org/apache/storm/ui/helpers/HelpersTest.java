package org.apache.storm.ui.helpers;
...
public class HelpersTest {
	...
	public void testUrlFormat() {
		String rest = Helpers.urlFormat("http://%s:%s/log?file=worker-%s.log",
				"test", 1234, 6701);
	...
	public void testSumTasks() {
		...
		Mockito.when(es1.get_executor_info())
				.thenReturn(new ExecutorInfo(1, 3));
		ExecutorSummary es2 = Mockito.mock(ExecutorSummary.class);
		Mockito.when(es2.get_executor_info())
				.thenReturn(new ExecutorInfo(4, 8));
	...
	public void testSwapMapOrder() {
		Map<StatsFields, Map<Object, Object>> test = new HashMap<StatsFields, Map<Object, Object>>();
