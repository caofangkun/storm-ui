 ...
 */
package org.apache.storm.ui.jetty;
...
import org.apache.storm.http.HtmlQuoting;
 ...
 * 
 */
public class JettyEmbeddedServer implements FilterContainer {
  public static final Logger LOG = LoggerFactory
      .getLogger(JettyEmbeddedServer.class);
  ...
  public JettyEmbeddedServer(String name, String bindAddress, int port,
  ...
  public JettyEmbeddedServer(String name, String bindAddress, int port,
    ...
    int maxThreads = 254;
    //    CoreUtil.parseInt(conf.get(Config.UI_HTTP_THREAD_MAX), 254);
  ...
  public static class StackServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      if (!JettyEmbeddedServer.hasAdministratorAccess(getServletContext(),
          request, response)) {
        return;
      }
