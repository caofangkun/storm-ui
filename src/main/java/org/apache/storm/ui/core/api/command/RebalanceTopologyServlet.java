 ...
 */
package org.apache.storm.ui.core.api.command;
 ...
 * 
 */
public class RebalanceTopologyServlet extends HttpServlet {
  private static final long serialVersionUID = 1L;
  private final static Logger LOG = LoggerFactory
      .getLogger(RebalanceTopologyServlet.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      sh.rebalance(topologyName, options);
      LOG.info("Rebalancing topology '{}' with wait time: {} secs",
          topologyName, waitTime);
